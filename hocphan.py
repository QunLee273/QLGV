# Form implementation generated from reading ui file 'hocphan.ui'
#
...
class Ui_Hocphan(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Mã học phần"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Tên học phần"))
    ...
    def insert_data(self):
        try:
            ...
            sqlquery = """SELECT hp.MaHP, hp.TenHP, hp.SoTinChi, gv.HoTen AS TenGiangVien, pc.HocKy, pc.NamHoc
                            FROM HocPhan hp
