# Form implementation generated from reading ui file 'danhgia.ui'
#
...
class Ui_Danhgia(object):
    def setupUi(self, MainWindow):
        ...
        self.phancong_btn1 = QtWidgets.QPushButton(parent=self.icon_only_widget, clicked = lambda :self.openGV())
        ...
        self.lichhoc_btn1 = QtWidgets.QPushButton(parent=self.icon_only_widget, clicked = lambda :self.openLH())
        ...
        self.hocphan_btn2 = QtWidgets.QPushButton(parent=self.full_menu_widget, clicked = lambda :self.openHP())
        icon7 = QtGui.QIcon()
        ...
        self.lophoc_btn2 = QtWidgets.QPushButton(parent=self.full_menu_widget, clicked = lambda :self.openLH())
        icon8 = QtGui.QIcon()
        ...
        self.phancong_btn2 = QtWidgets.QPushButton(parent=self.full_menu_widget, clicked = lambda :self.openPC())
        icon9 = QtGui.QIcon()
        ...
        self.lichhoc_btn2 = QtWidgets.QPushButton(parent=self.full_menu_widget, clicked = lambda :self.openLH())
        icon10 = QtGui.QIcon()
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Mã đánh giá"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Họ tên giảng viên"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Họ tên sinh viên"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Nội dung"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Điểm số"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Ngày đánh giá"))
    ...
    def insert_data(self):
        try:
            ...
            sqlquery = """SELECT dg.MaDG, gv.HoTen, sv.HoTen, dg.NoiDung, dg.DiemSo, dg.NgayDanhGia
                        FROM DanhGia dg
