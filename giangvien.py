...
class UI_Giangvien(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.danhgia_btn1 = QtWidgets.QPushButton(parent=self.icon_only_widget, clicked = lambda :self.openDD())
        ...
        self.danhgia_btn2 = QtWidgets.QPushButton(parent=self.full_menu_widget, clicked = lambda :self.openDD())
        icon10 = QtGui.QIcon()
